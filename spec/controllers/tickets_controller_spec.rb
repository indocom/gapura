  ...
  describe 'POST #create' do
    context 'with valid params' do
      it 'creates a new Ticket' do
        expect {
          post :create,
               params: { ticket: valid_attributes }, session: valid_session
    ...
    context 'with invalid params' do
      it "returns a success response (i.e. to display the 'new' template)" do
        post :create,
             params: { ticket: invalid_attributes }, session: valid_session
        expect(response).to be_successful
      end
    end
  end
  ...
  describe 'PUT #update' do
    context 'with valid params' do
      ...
      it 'updates the requested ticket' do
        ticket = Ticket.create! valid_attributes
        put :update,
            params: { id: ticket.to_param, ticket: new_attributes },
      ...
      it 'redirects to the ticket' do
        ticket = Ticket.create! valid_attributes
        put :update,
            params: { id: ticket.to_param, ticket: valid_attributes },
            session: valid_session
    ...
    context 'with invalid params' do
      it "returns a success response (i.e. to display the 'edit' template)" do
        ticket = Ticket.create! valid_attributes
        put :update,
            params: { id: ticket.to_param, ticket: invalid_attributes },
            session: valid_session
        expect(response).to be_successful
      end
    end
