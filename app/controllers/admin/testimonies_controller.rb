...
class Admin::TestimoniesController < ApplicationController
  ...
  def create
    ...
    if @testimony.save
      redirect_to admin_testimony_url(@testimony),
                  notice: 'Testimony was successfully created.'
    else
      render :new
    end
  end
  ...
  def update
    if @testimony.update(testimony_params)
      redirect_to admin_testimony_url(@testimony),
                  notice: 'Testimony was successfully updated.'
    else
      render :edit
    end
  end
  ...
  def destroy
    @testimony.destroy
    redirect_to admin_testimonies_url,
                notice: 'Testimony was successfully destroyed.'
  end
  ...
  def testimony_params
    params.require(:testimony).permit(
      ...
      :profession,
      :testimony,
      photo_attributes: %i[id file _destroy]
    )
  end
end
