...
RSpec.describe Admin::TicketsController, type: :routing do
  describe 'routing' do
    ...
    it 'routes to #edit' do
      expect(get: '/admin/tickets/1/edit').to route_to(
        'admin/tickets#edit',
        id: '1'
      )
    end
    ...
    it 'routes to #update via PUT' do
      expect(put: '/admin/tickets/1').to route_to(
    ...
    it 'routes to #update via PATCH' do
      expect(patch: '/admin/tickets/1').to route_to(
        'admin/tickets#update',
        id: '1'
      )
    end
    ...
    it 'routes to #destroy' do
      expect(delete: '/admin/tickets/1').to route_to(
