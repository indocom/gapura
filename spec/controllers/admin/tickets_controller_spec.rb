  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Admin::Ticket" do
        expect {
          post :create, params: {admin_ticket: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'new' template)" do
        post :create, params: {admin_ticket: invalid_attributes}, session: valid_session
        expect(response).to be_successful
      end
    end
  end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested admin_ticket" do
        ticket = Admin::Ticket.create! valid_attributes
        put :update, params: {id: ticket.to_param, admin_ticket: new_attributes}, session: valid_session
        ticket.reload
      ...
      it "redirects to the admin_ticket" do
        ticket = Admin::Ticket.create! valid_attributes
        put :update, params: {id: ticket.to_param, admin_ticket: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'edit' template)" do
        ticket = Admin::Ticket.create! valid_attributes
        put :update, params: {id: ticket.to_param, admin_ticket: invalid_attributes}, session: valid_session
        expect(response).to be_successful
      end
    end
  end
