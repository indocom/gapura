...
RSpec.describe Admin::GalleryPhotosController, type: :controller do
  ...
  describe 'POST #create' do
    context 'with valid params' do
      it 'creates a new Admin::GalleryPhoto' do
        expect {
          post :create,
               params: { admin_gallery_photo: valid_attributes },
    ...
    context 'with invalid params' do
      it "returns a success response (i.e. to display the 'new' template)" do
        post :create,
             params: { admin_gallery_photo: invalid_attributes },
             session: valid_session
        expect(response).to be_successful
      end
    end
  ...
  describe 'PUT #update' do
    context 'with valid params' do
      ...
      it 'updates the requested admin_gallery_photo' do
        ...
        put :update,
            params: {
              id: gallery_photo.to_param, admin_gallery_photo: new_attributes
            },
            session: valid_session
      ...
      it 'redirects to the admin_gallery_photo' do
        ...
        put :update,
            params: {
              id: gallery_photo.to_param, admin_gallery_photo: valid_attributes
            },
            session: valid_session
    ...
    context 'with invalid params' do
      it "returns a success response (i.e. to display the 'edit' template)" do
        ...
        put :update,
            params: {
              id: gallery_photo.to_param,
              admin_gallery_photo: invalid_attributes
            },
            session: valid_session
        expect(response).to be_successful
      end
  ...
  describe 'DELETE #destroy' do
    it 'destroys the requested admin_gallery_photo' do
      ...
      expect {
        delete :destroy,
               params: { id: gallery_photo.to_param }, session: valid_session
      }.to change(Admin::GalleryPhoto, :count).by(-1)
    end
