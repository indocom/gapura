 ...
 * 
 * To achieve the desired result in 'nuansa-cp/gapura' (https://github.com/nuansa-cp/gapura) project,
 * there are some minor modifications in the `addVerticalNavigation` and `getBulletLinkName` functions.
 */
...
(function( root, window, document, factory, undefined) {
    ...
    function initialise(containerSelector, options) {
        ...
        * DON'T REMOVE; required in setMouseHijack
        */
        ...
        */
         ...
         * 
         * Removing this seems to make the 'View More' button appear inside the container
        ...
        */
        function addVerticalNavigation(){
            ...
            for (var i = 0; i < $(SECTION_SEL).length; i++) {
                ...
                li += '<li><a href="#' + link + '"><span class="fp-sr-only">' + getBulletLinkName(i, 'Section') + '</span></a>';
            ...
            // uncomment to position navigation in the middle - (centering it vertically)
        ...
        */
        function getBulletLinkName(i, defaultName){
            return options.navigationBulletNames[i]
        ...
        */
        function scrollPage(element, callback, isMovementUp){
            ...
            // uncoment to differentiate between scrolling up and down
            // var dtop = getDestinationPosition(element);
            var dtop = element.offsetTop;
            var slideAnchorLink;
            var slideIndex;
