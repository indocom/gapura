...
ActiveRecord::Schema.define(version: 20_191_020_045_617) do
  ...
  create_table 'claim_histories', force: :cascade do |t|
    ...
    t.index %w[ticket_id], name: 'index_claim_histories_on_ticket_id'
  end

  create_table 'customers', force: :cascade do |t|
    t.string 'email', default: '', null: false
    t.index %w[email], name: 'index_customers_on_email', unique: true
  end
  ...
  create_table 'event_info', force: :cascade do |t|
    ...
    t.string 'video_link'
    t.integer 'year'
    t.index %w[year], name: 'index_event_info_on_year', unique: true
  end
  ...
  create_table 'event_previews', force: :cascade do |t|
    ...
    t.text 'preview_info'
    t.index %w[year], name: 'index_event_previews_on_year'
  end
  ...
  create_table 'events', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[title], name: 'index_events_on_title', unique: true
    t.index %w[year], name: 'index_events_on_year', unique: true
  end
  ...
  create_table 'gallery_photos', force: :cascade do |t|
    ...
    t.integer 'year', null: false
    t.datetime 'created_at', null: false
    t.index %w[year], name: 'index_gallery_photos_on_year'
  end
  ...
  create_table 'images', force: :cascade do |t|
    ...
    t.string 'mime_type'
    t.string 'filename'
    t.index %w[imageable_type imageable_id],
  ...
  create_table 'sponsors', force: :cascade do |t|
    ...
    t.index %w[year], name: 'index_sponsors_on_year'
  end
  ...
  create_table 'subscribers', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[customer_id], name: 'index_subscribers_on_customer_id'
  end
  ...
  create_table 'tickets', force: :cascade do |t|
    ...
    t.index %w[booking_reference ticket_type],
            name: 'index_tickets_on_booking_reference_and_ticket_type',
            unique: true
    t.index %w[claim_token], name: 'index_tickets_on_claim_token', unique: true
    t.index %w[customer_id], name: 'index_tickets_on_customer_id'
  end
  ...
  create_table 'transactions', force: :cascade do |t|
    ...
    t.string 'name', default: '', null: false
    t.index %w[booking_reference ticket_type],
            name: 'index_transactions_on_booking_reference_and_ticket_type',
            unique: true
  end
  ...
  add_foreign_key 'event_previews',
                  'events',
                  column: 'year', primary_key: 'year'
  add_foreign_key 'gallery_photos',
                  'events',
                  column: 'year', primary_key: 'year'
